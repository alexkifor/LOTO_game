...
Перед началом игры пользователю нужно выбрать уровень сложности игры hard, medium или easy в зависимости от времени на один ход пользователя соответственно: 4, 6 или 8 секунд. Если пользователь по ходу игры не уложиться в данное время, то он проигрывает и игра завершается.
